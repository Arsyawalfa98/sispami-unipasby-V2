...
@section('main-content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">{{ __('Tambah Dokumen SPMI & AMI') }}</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('dokumen-spmi-ami.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="mt-2">
                        <small class="text-muted">Format yang diizinkan: PDF, DOC, DOCX (Maks. 10MB)</small>
                    </div>
