{{-- resources/views/ptkrhr/index.blade.php --}}
...
@section('main-content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Permintaan Tindakan Koreksi (PTK) & Rekapitulasi Hasil Rencana Tindak Lanjut</h1>
    </div>

    <div class="card shadow mb-4">
        <div class="card-header">
            <form method="GET" action="{{ route('ptkrhr.index') }}" class="mb-0">
                <div class="row mb-2">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-1 text-right">
                        <a href="{{ route('ptkrhr.index') }}" class="btn btn-secondary">
