...
@section('main-content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Judul Kriteria Dokumen</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="POST" action="{{ route('judul-kriteria-dokumen.update', $judulKriteriaDokumen->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_kriteria_dokumen') is-invalid @enderror" 
                           id="nama_kriteria_dokumen" name="nama_kriteria_dokumen" 
                           value="{{ old('nama_kriteria_dokumen', $judulKriteriaDokumen->nama_kriteria_dokumen) }}" required>
