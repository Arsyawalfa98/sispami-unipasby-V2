...
@section('main-content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Lembaga Akreditasi</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="POST" action="{{ route('lembaga-akreditasi.update', $lembagaAkreditasi->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                        name="nama" value="{{ old('nama', $lembagaAkreditasi->nama) }}" required>
                    @error('nama')
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('tahun') is-invalid @enderror" id="tahun"
                        name="tahun" value="{{ old('tahun', $lembagaAkreditasi->tahun) }}" min="2000"
                            ...
                            <div class="row mb-3 prodi-item">
                                <div class="col-md-5">
                                    <div class="position-relative">
                                        <input type="text" class="form-control prodi-search" value="{{ $detail->prodi }}"
