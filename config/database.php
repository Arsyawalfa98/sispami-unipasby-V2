...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mitra' => [
            'driver' => 'pgsql',
            'host' => env('MITRA_DB_HOST', '127.0.0.1'),
            'port' => env('MITRA_DB_PORT', '5432'),
            'database' => env('MITRA_DB_DATABASE', 'forge'),
            'username' => env('MITRA_DB_USERNAME', 'forge'),
            'password' => env('MITRA_DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'sslmode' => 'prefer',
        ],
