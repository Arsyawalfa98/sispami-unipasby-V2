...
class KriteriaDokumenRepository
{
    ...
    /**
     * Mengembalikan Query Builder untuk KriteriaDokumen dengan semua filter role-based.
     *
     * @param array $filters
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function getKriteriaDokumenQuery($filters = [])
    {
        $user = Auth::user();
        ...
        return $query->orderBy('periode_atau_tahun', 'desc')
            ->orderBy('jenjang_id', 'asc');
    }

    public function getAllKriteriaDokumenWithDetails($filters = [])
    {
        return $this->getKriteriaDokumenQuery($filters)->get();
    }
